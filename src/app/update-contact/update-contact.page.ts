    ...
    .subscribe(contact => {
      ...
      if (!contact) {
        ...
        this.updateContactForm = new FormGroup({
          ...
          'autor': new FormControl(this.contact.autor, Validators.required),
          'resumen': new FormControl(this.contact.resumen),
          'valoracion': new FormControl(this.contact.valoracion, Validators.required),
          'categoria': new FormControl(this.contact.categoria, Validators.required)
        });
